...
var mailService = app.Services.GetService<Application.Services.MailService.IMailService>();
mailService.ScheduleDeleteExpiredReservationsThenSendEmailAsync();
mailService.ScheduleReminderEmailTwoDaysBeforeReturnDateAsync();
