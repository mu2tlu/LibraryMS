...
{
    public Application.Features.Auth.Dtos.UserForLoginDto UserForLoginDto { get; set; }
    ...
    public LoginCommand(Application.Features.Auth.Dtos.UserForLoginDto userForLoginDto, string ipAddress)
    {
