...
public class CreateItemCommandValidator : AbstractValidator<CreateItemCommand>
{
    public CreateItemCommandValidator()
    {
        ...
        RuleFor(c => c.Isbn).Must(isbn => isbn.Length.Equals(8) || isbn.Length.Equals(10) || isbn.Length.Equals(13)).WithMessage("ISSN must be either 8, 10 or 13 characters long.");
