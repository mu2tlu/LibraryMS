...
public class UserManager : IUserService
{
    ...
    //{
    //    return await _userRepository.GetUserEmail(id);
    //}
    //public async Task<string> GetItemType(Guid id)
    //{
    //    return await _userRepository.GetItemType(id);
    //}
    //public async Task<string> GetItemName(Guid id)
    //{
    //    return await _userRepository.GetItemName(id);
    //}
}
