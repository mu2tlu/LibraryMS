...
namespace Persistence.Migrations
{
    ...
    [Migration("20240517175147_borrow")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2dffa77f-7314-4b46-b5af-d6bc9d75726c"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 113, 168, 37, 14, 195, 238, 120, 246, 245, 189, 36, 169, 133, 33, 251, 133, 143, 52, 202, 227, 106, 226, 132, 176, 119, 187, 183, 160, 64, 49, 58, 121, 131, 184, 250, 225, 93, 191, 14, 205, 172, 238, 85, 99, 245, 154, 201, 28, 175, 40, 190, 199, 253, 54, 154, 233, 64, 103, 208, 184, 180, 221, 172, 235 },
                            PasswordSalt = new byte[] { 213, 118, 254, 113, 220, 133, 250, 86, 159, 141, 218, 233, 149, 2, 173, 11, 218, 250, 97, 73, 46, 62, 190, 93, 194, 220, 204, 208, 12, 241, 36, 6, 53, 149, 108, 119, 157, 104, 236, 131, 252, 184, 33, 226, 52, 221, 224, 64, 6, 214, 112, 34, 179, 63, 212, 215, 17, 215, 47, 52, 58, 147, 165, 198, 210, 120, 105, 16, 68, 145, 1, 163, 191, 114, 129, 79, 181, 33, 188, 129, 149, 160, 67, 136, 169, 44, 129, 161, 162, 134, 188, 22, 210, 32, 211, 201, 1, 180, 25, 92, 203, 144, 64, 216, 57, 83, 134, 196, 17, 123, 110, 200, 165, 179, 18, 184, 195, 185, 134, 0, 235, 236, 117, 115, 254, 83, 151, 112 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8e21dd07-5251-476f-b97b-e806ce1e1d58"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("2dffa77f-7314-4b46-b5af-d6bc9d75726c")
                        });
                });
