...
namespace Persistence.Migrations
{
    ...
    [Migration("20240521210638_paymentchanges")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("18f47144-14d1-40bd-a237-614135e7d668"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 196, 77, 203, 8, 192, 115, 182, 64, 24, 189, 75, 24, 22, 55, 119, 211, 137, 184, 225, 205, 11, 127, 177, 174, 120, 193, 218, 59, 95, 127, 233, 192, 41, 93, 146, 188, 61, 81, 84, 12, 140, 188, 122, 222, 217, 144, 154, 185, 183, 154, 104, 114, 117, 217, 73, 167, 210, 72, 202, 83, 190, 83, 190, 1 },
                            PasswordSalt = new byte[] { 17, 17, 123, 194, 173, 247, 146, 231, 202, 83, 90, 102, 156, 31, 18, 156, 93, 164, 147, 211, 221, 105, 235, 72, 142, 210, 30, 66, 129, 53, 8, 157, 4, 105, 6, 99, 196, 53, 175, 212, 48, 85, 19, 86, 5, 113, 24, 138, 207, 78, 234, 187, 140, 138, 189, 80, 253, 139, 10, 229, 101, 207, 167, 57, 17, 195, 224, 233, 51, 10, 84, 70, 174, 118, 230, 232, 6, 11, 178, 242, 53, 60, 87, 58, 142, 113, 100, 159, 14, 45, 213, 77, 194, 92, 45, 14, 53, 236, 121, 202, 180, 233, 55, 56, 122, 61, 139, 191, 2, 130, 50, 97, 151, 184, 130, 120, 130, 86, 30, 126, 68, 208, 115, 16, 186, 0, 159, 248 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("60260c47-dacb-4b2a-ad0e-f7ee94b5dc7c"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("18f47144-14d1-40bd-a237-614135e7d668")
                        });
                });
