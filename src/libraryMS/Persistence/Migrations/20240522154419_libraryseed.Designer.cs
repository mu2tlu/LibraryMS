...
namespace Persistence.Migrations
{
    ...
    [Migration("20240522154419_libraryseed")]
    partial class libraryseed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Library", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("480aedf0-b072-44c3-9448-8f8ba0f2e403"),
                            Address = "İstanbul Sarıyer",
                            City = "İstanbul",
                            CreatedDate = new DateTime(2024, 5, 22, 18, 44, 19, 365, DateTimeKind.Local).AddTicks(7520),
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3764810c-a60a-4558-958b-f1ddb6d8486d"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 86, 237, 63, 196, 235, 57, 85, 11, 247, 71, 54, 161, 41, 43, 123, 58, 194, 105, 38, 8, 85, 191, 108, 27, 149, 12, 209, 118, 4, 177, 182, 179, 202, 78, 219, 203, 24, 114, 175, 191, 183, 150, 103, 144, 248, 148, 156, 5, 233, 55, 255, 167, 204, 52, 239, 229, 104, 200, 90, 83, 232, 255, 228, 243 },
                            PasswordSalt = new byte[] { 197, 164, 202, 128, 69, 255, 73, 99, 7, 75, 176, 39, 199, 209, 35, 98, 181, 183, 110, 41, 180, 243, 72, 222, 3, 162, 246, 222, 251, 34, 108, 222, 10, 149, 151, 23, 134, 159, 94, 54, 200, 147, 155, 184, 96, 184, 58, 104, 198, 65, 153, 140, 152, 155, 211, 151, 3, 186, 174, 226, 98, 228, 10, 16, 67, 87, 138, 206, 148, 125, 94, 156, 91, 199, 157, 164, 151, 235, 86, 101, 134, 182, 34, 228, 123, 131, 74, 47, 82, 117, 85, 235, 224, 52, 122, 73, 119, 162, 231, 94, 128, 133, 198, 1, 182, 228, 23, 79, 64, 168, 14, 130, 15, 85, 138, 166, 176, 241, 82, 169, 188, 168, 244, 201, 194, 182, 164, 70 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9a67bb84-9cb8-4ab5-9be3-f0499f8d9460"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("3764810c-a60a-4558-958b-f1ddb6d8486d")
                        });
                });
